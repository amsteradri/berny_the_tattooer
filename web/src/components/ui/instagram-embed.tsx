  ...
  return (
    <div className="flex justify-center w-full h-full overflow-y-auto">
        <blockquote 
            ...
            data-instgrm-permalink="https://www.instagram.com/reel/DBRj12TILnE/?utm_source=ig_embed&amp;utm_campaign=loading" 
        ...
        <div style={{padding: "16px"}}>
             <a href="https://www.instagram.com/reel/DBRj12TILnE/?utm_source=ig_embed&amp;utm_campaign=loading" style={{ background: "#FFFFFF", lineHeight: "0", padding: "0 0", textAlign: "center", textDecoration: "none", width: "100%" }} target="_blank" rel="noreferrer">
             ...
             <p style={{ color: "#c9c8cd", fontFamily: "Arial,sans-serif", fontSize: "14px", lineHeight: "17px", marginBottom: "0", marginTop: "8px", overflow: "hidden", padding: "8px 0 7px", textAlign: "center", textOverflow: "ellipsis", whiteSpace: "nowrap" }}>
                 <a href="https://www.instagram.com/reel/DBRj12TILnE/?utm_source=ig_embed&amp;utm_campaign=loading" style={{ color: "#c9c8cd", fontFamily: "Arial,sans-serif", fontSize: "14px", fontStyle: "normal", fontWeight: "normal", lineHeight: "17px", textDecoration: "none" }} target="_blank" rel="noreferrer">
                    Una publicación compartida de Berny Aguilera (@berny_the_tattooer)
                 </a>
             </p>
        </div>
        </blockquote>
